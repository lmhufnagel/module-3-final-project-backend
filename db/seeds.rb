...
Review.create(name: "Terrance", body: "Poop", rating: 1, haunted_house_id: 2)
Review.create(name: "Lisa", body: "So Scary!", rating: 3, haunted_house_id: 1)
Review.create(name: "Lisa", body: "So Scary!", rating: 1, haunted_house_id: 1)
Review.create(name: "Lisa", body: "So Scary!", rating: 2, haunted_house_id: 1)
